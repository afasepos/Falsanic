const { ChannelType, ButtonInteraction, EmbedBuilder, ActionRowBuilder, ButtonStyle, PermissionFlagsBits, ButtonBuilder } = require("discord.js");
        ...
        try {
            await guild.channels.create({
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription("Our team will contact you shortly. Please describe your issue and wait patiently.")
                ...
                interaction.reply({ content: "Your ticket was successfully created.", ephemeral: true });
            });
        } catch (err) {
