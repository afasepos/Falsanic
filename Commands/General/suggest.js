...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName("type")
                .setDescription("Select an option that best describes the topic of your suggestion.")
                .setRequired(true)
                .addChoices(
    ...
    async execute(interaction) {
        ...
        const channel = guild.channels.cache.get("1140604240436400188");
        ...
        const buttons = new ActionRowBuilder().addComponents(
            ...
            new ButtonBuilder().setCustomId("suggest-decline").setLabel("Decline").setStyle(ButtonStyle.Danger) // you can use this format but, I wil change it to this:
        );
        ...
        try {
            ...
            await interaction.reply({ content: "The suggestion was sent successfully to the channel.", ephemeral: true });
