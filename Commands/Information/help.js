...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("help")
        .setDescription("Get a list of all the commands from a certain category.")
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setDescription("See a list of commands by selecting a category down below.")
            .setColor("#235ee7")
                ...
                const categoryEmbed = new EmbedBuilder()
                    ...
                    .addFields(
                        category.commands.map((cmd) => ({
                            name: `</${cmd.name}:${getCommand(cmd.name)}>`, // displays a clickable command
